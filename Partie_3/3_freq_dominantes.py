...
spectrum = np.abs(librosa.stft(y, n_fft=4000, hop_length=80))
frequencies = librosa.fft_frequencies(sr=sr, n_fft=len(spectrum))
...
plt.plot(frequencies[:400], power[:400], label="Spectre du signal")
